    ...
    return (
        ...
        >
            <Dropdown.Menu>
                ...
                <Dropdown.Divider />
                {props.role === "admin" || props.role ==="owner" ? <Dropdown.Item>Изменить название группы</Dropdown.Item>  : ""}
                {props.role === "owner" ? <Dropdown.Item>Передать права владельца</Dropdown.Item>  : ""}
