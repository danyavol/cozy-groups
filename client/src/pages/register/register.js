            ...
            <Fragment>
                <form onSubmit = {this.handleSubmit} className="ui form attached segment padded container text" autoComplete="off">
                    ...
                    <div className={`field required ${this.state.loginError ? 'error' : ''}`}>
                        <label>Логин</label>
                        <input type="text" name="login" placeholder="Введите логин" value = {this.state.login} onChange = {this.handleInputChange} />
                    ...
                    <div className="two fields">
                        <div className={`field required ${this.state.firstNameError ? 'error' : ''}`}>
                            <label>Имя</label>
                            <input type="text" name="firstName" placeholder="Введите имя" value = {this.state.firstName} onChange = {this.handleInputChange} />
                        ...
                        <div className={`field ${this.state.lastNameError ? 'error' : ''}`}>
                            <label>Фамилия</label>
                            <input type="text" name="lastName" placeholder="Введите фамилию" value = {this.state.lastName} onChange = {this.handleInputChange} />
                    ...
                    <div className="field required">
                        ...
                        <div className="two fields">
                            <div className={`field ${this.state.passwordError ? 'error' : ''}`}>
                                <input type="password" name="password" placeholder="Введите пароль" value = {this.state.password} onChange = {this.handleInputChange} />
                            ...
                            <div className={`field ${this.state.passwordConfirmError ? 'error' : ''}`}>
                                <input type="password" name="passwordConfirm" placeholder="Повторите пароль" value = {this.state.passwordConfirm} onChange = {this.handleInputChange}  />
                    ...
                    <button className={`ui blue button ${this.state.loading ? 'loading' : ''}`} type="submit" disabled={this.state.loading ? 'disabled' : ''}>Создать аккаунт</button>
                </form>
